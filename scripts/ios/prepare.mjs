...
import { sourceHashes, sealPrepared } from './provenance.mjs';
import { verifyPublicAppIcon, verifySourceAppIcon } from './verify-app-icon.mjs';
...
run('scripts/ios/presence-assets.mjs', []);
...
sealPrepared(root, before, metadata);
run('scripts/ios/check.mjs', ['--assets-only']);
console.log('资源和源码已校验。请使用 npm run ios:install -- --device <设备ID> 构建、校验并安装当前版本。');
