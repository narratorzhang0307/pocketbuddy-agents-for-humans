...
export type EdgeAssetId = 'qwen3-vl-2b-mnn' | 'guji-vision-lora' | 'rubbing-vision-lora' | 'general-ocr-vision-lora' | 'aesthetic-curator-vision-lora' | 'travel-planner-lora' | 'heritage-restorer' | 'exhibit-matting';
...
export type EdgeRequest =
  | { task: 'ping' }
  | { task: 'chat'; prompt: string; system?: string; json?: boolean; adapter?: string; maxTokens?: number; purpose?: string }
...
export interface EdgeResponse {
  backend: 'ollama' | 'mnn' | 'native-ocr' | 'stub';
  model?: string;
