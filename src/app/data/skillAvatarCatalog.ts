...
export const SKILL_AVATARS: SkillAvatarOption[] = [
  ...
  { id: 'semantic-owl', name: '决策猫头鹰', role: '整理信息再判断', assetUrl: `${ASSET_BASE}semantic-owl.png`, accent: '#a8b77e', capability: 'model.gemma' },
  ...
  { id: 'evidence-elephant', name: '记忆小象', role: '保存结果与证据', assetUrl: `${ASSET_BASE}evidence-elephant.png`, accent: '#95a77a', capability: 'state.skill_completed' },
];
